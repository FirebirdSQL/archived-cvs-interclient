...
const char *const VersionInformation::DRIVER_VERSION__ = "1.60"; // string
const int VersionInformation::DRIVER_MAJOR_VERSION__ = 1;
const int VersionInformation::DRIVER_MINOR_VERSION__ = 60;

const int VersionInformation::REMOTE_PROTOCOL_VERSION__ = 16001;
const int VersionInformation::REMOTE_MESSAGE_CERTIFICATE__ = 16001;

const char *const VersionInformation::SERVER_NAME__ = "InterServer";
const int VersionInformation::SERVER_MAJOR_VERSION__ = 1; // must be int
const int VersionInformation::SERVER_MINOR_VERSION__ = 60; // must be int
const int VersionInformation::SERVER_BUILD_NUMBER__ = 1; // int > 0
const int VersionInformation::SERVER_BUILD_LEVEL__ = 2; // 0 for test build, 1 for beta, and 2 for final
